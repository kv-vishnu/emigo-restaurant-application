...
class Order extends CI_Controller {
	...
	public function index()
	{
		...
		$data['out_for_delivery_orders']=$this->Ordermodel->getOutForDeliveryOrders($logged_in_store_id); //Ready orders
		...
		$this->load->view('kitchen/kitchen_orderdashboard',$data);
		$this->load->view('kitchen/includes/footer');
	}

	//MARK:Pending Table Orders
	public function approved_order_details($orderId)
	{
		...
		$this->load->view('kitchen/order/approved_order_details',$data);
	}
	...
	public function ready_order_details($orderId)
	{
		$data['orders']=$this->Ordermodel->order_details($this->session->userdata('logged_in_store_id') , $orderId);
		$data['kot_enable'] = $this->Ordermodel->getKotEnabledStatus($this->session->userdata('logged_in_store_id'));
		$this->load->view('kitchen/order/ready_order_details',$data);
	}
	...
	public function delivered_order_details($orderId)
	{
		$data['orders']=$this->Ordermodel->order_details($this->session->userdata('logged_in_store_id') , $orderId);
		$data['kot_enable'] = $this->Ordermodel->getKotEnabledStatus($this->session->userdata('logged_in_store_id'));
		$this->load->view('kitchen/order/delivered_order_details',$data);
	}
	//MARK:Accept order
	public function change_order_status()
	{
		...
		$this->Ordermodel->change_order_status($store_id,$order_id,$data);
		echo json_encode(['status' => 'success']);
	}

	public function change_order_status_with_ofd()
	{
		$order_id = $this->input->post('orderId');
		$status = $this->input->post('status');
		$store_id = $this->session->userdata('logged_in_store_id');
		...
		$this->Ordermodel->change_order_status_with_ofd($store_id,$order_id,$data);
		echo json_encode(['status' => 'success']);
	}
	...
	public function print_order(){
		...
		echo $this->load->view('kitchen/order/print_order',$data,TRUE);
	}
