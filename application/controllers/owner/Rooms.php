...
class Rooms extends MY_Controller {
 public function __construct() {
		...
		$this->load->model('owner/Roommodel');
		$this->load->model('admin/Packagemodel');
 ...
 public function index(){
  $controller = $this->router->fetch_class(); // Gets the current controller name
		...
		$this->render_shopowner_header('owner/rooms', $data);
}
public function pending_room_orders($tableid)
	{
		...
		$data['suppliers'] = $this->Roommodel->getsuppliers($store_id, $tableid);
		$data['orders'] = $this->Roommodel->pending_room_orders($store_id, $tableid);
		$data['kot_enable'] = $this->Roommodel->getKotEnabledStatus($store_id);
