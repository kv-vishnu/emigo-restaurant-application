        ...
        <div class="tabs orderdashboard-tab">
            <div class="tabs__row">
                <ul class="tabs__nav">
                    ...
                    <?php if ($storeDetails[0]['is_table_tab'] == 1 && $this->session->userdata('user_id') != 266): ?>
                    ...
                    <li class="<?php echo !$activeTabSet ? 'active' : ''; ?>">
                        <?php $activeTabSet = true; ?>
                        <a href="#tabs2">Takeaway Orders <span id="tabs__nav_pending_pickup_count" class="d-none"></span>
                        </a>
                    </li>
                    <?php endif; ?>
                    ...
                    <?php if ($storeDetails[0]['is_room_tab'] == 1 && $this->session->userdata('user_id') != 266): ?>
                    <li class="<?php echo !$activeTabSet ? 'active' : ''; ?>">
                        <?php $activeTabSet = true; ?>
                    ...
                    <li class=""><a href="#tabs4">Ready Orders<span id="tabs__nav_approved_ready_count_db" style="display:none;"></span>
                        </a></li>
                    <li class="">
                ...
                <div class="tabs__content orderdashboard-tab__content">
                    ...
                    <div id="tabs1" class="tabs__pane <?php echo !$activeTabSet ? 'active' : ''; ?> ">
                        ...
                        <div class="order-table-list vfff">
                            ...
                            <div class="order-table-list__item">
                                ...
                                <div class="order-table-list__item-content">
                                    ...
                                    <div class="order-table-list__completed-reserved">
                                        ...
                                        <a data-table-id="<?php echo $table['table_id']; ?>"
                            ...
                            <div class="orders-data__content">
                                <div class="orders-data__order-details">
                                    <a data-id="PK" data-bs-toggle="modal" data-name="Pickup Orders"
                                        data-bs-target="#pending_table_orders_popup" class="pending_pickup_orders">
                                        <div
                            ...
                            <div class="orders-data__content">
                                <div class="orders-data__order-details">
                                    <a data-bs-toggle="modal" data-name="Delivery Orders" data-bs-target="#pending_table_orders_popup"
                                        data-id="DL" class="pending_delivery_orders">
                                        <div
                                            class="orders-data__order-details-heading orders-data__order-details-heading-details">
                    ...
                    <div id="tabs4" class="tabs__pane">
                        <div class="order-table-list" id="ready-orders-db">
                            ...
                            <div class="order-table-list__item">
                                ...
                                <button type="button" class="btn <?php echo $btn_class; ?>"><?php echo $order['approved_by_name']; ?>
                                <button type="button"
                                    class="btn <?php echo $btn_class; ?>"><?php echo $order_status; ?>(<?= $order['delivered_time'] ?>)</button>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                      ...
                      <div id="tabs6" class="tabs__pane">
                        <div class="order-table-list" id="delivered-orders-db">
                            ...
                            <div class="order-table-list__item">
                                ...
                                <!--<button type="button" class="btn <?php echo $btn_class; ?>"><?php echo $order['approved_by_name']; ?></button>-->
                                    <?php if ($order['paid_by'] != 0): ?>
                                        <button type="button" class="btn <?= $btn_class; ?>">PAID BY : <?= $order['paid_by']; ?></button>
                                    <?php endif; ?>
                                <button type="button" class="btn <?php echo $btn_class; ?>"><?php echo $order_status; ?>(<?php echo $order['out_for_delivery_time']; ?>)</button>
                                <button class="btn btn-pay pay_order d-block mt-2 w-100" <?= $pay_btn_disabled ?>  data-order-id="<?= $order['orderno']; ?>">PAY </button>
                            </div>
                            <?php } ?>
