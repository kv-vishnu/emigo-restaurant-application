                ...
                <div class="accordion-item <?php echo $isFirst; ?> ">
                    ...
                    <div class="accordion-body">
                        ...
                        <?php
                            ...
                            $approved_user = 266; //$order['approved_by'];
                        ...
                        <div class="action-buttons order-row">
                            ...
                            <button class="btn btn-print" onclick="editOrder(1234)">Print</button>
                            <button class="btn btn-delete" onclick="cancelOrder(1234)">Delete</button>
