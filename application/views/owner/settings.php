    ...
    <div class="application-content__container settings-content__container container">
        ...
        <div class="settings-content__button-blocks owner">
            <!-- <a class="settings-content__btn btn1" data-bs-toggle="modal" data-bs-target="#edit-time"><img
                    ...
                    src="<?php echo base_url();?>assets/admin/images/edit-time-icon.svg" alt="edit time">Time</a>
            <a class="settings-content__btn btn1" data-bs-toggle="modal" data-bs-target="#holiday"><img
                    class="settings-content__btn-icon"
                    src="<?php echo base_url();?>assets/admin/images/edit-holidays-icon.svg"
                    alt="edit holidays">Holidays</a> -->
            ...
            <!-- <a class="settings-content__btn btn1 close-order"><img class="settings-content__btn-icon"
                    src="<?php echo base_url();?>assets/admin/images/closed-icon.svg" alt="add/list user">Pause
                Order</a>
            ...
            <a class="settings-content__btn btn1" id="list-qrcode" data-id="<?php echo $store_id ?>"
                data-bs-target="#qr-code" data-bs-toggle="modal"><img class="settings-content__btn-icon"
            ...
            <form action="<?php echo base_url(); ?>owner/rooms/index" method="post">
