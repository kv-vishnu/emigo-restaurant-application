    ...
    <div class="application-footer__container container">
        <div class="application-footer__company-logo">
            <img src="<?php echo base_url();?>uploads/store/<?php echo $store_logo; ?>" alt="Store logo"
                class="application-footer__company-logo-img " width="80" height="69">
        </div>
        ...
        <div class="application-footer__company-logo">
            ...
            <img class="" src="<?php echo base_url();?>assets/admin/images/ChoosemyfoodLogo.png" alt="Choose My Food"  width="80" height="69">
        </div>
    </div>
</div>
