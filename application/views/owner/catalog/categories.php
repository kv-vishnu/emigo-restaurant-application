                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Categories - <?php echo $this->session->userdata('store_name'); ?></h4>
 ...
 $date=date("d",$time);  ?>
                    ...
                    <div class="alert alert-danger dark" role="alert">
                        ...
                        <div class="">
                            ...
                            <a class="btn btn-primary mb-2 f-right" href="<?php echo base_url(); ?>owner/Categories/add" role="button"><i class="fa fa-plus"></i> Add Category</a>
        ...
        <?php
            ...
            <tr>
                ...
                <td><img width="50" height="50" src="<?php echo base_url(); ?>uploads/categories/<?php if(isset($val['category_img'])) echo $val['category_img']; ?>" class="img-thumbnail"></td>
                ...
                <td class="pb-0 pt-0 d-flex">
                    <form class="m-0" action="<?php echo base_url();?>owner/categories/edit" method="post">
                                      <input type="hidden" name="id" value="<?php echo $val['category_id']; ?>"> 
                                        <button class="btn tblEditBtn pl-0 pr-0" type="submit" data-bs-toggle="tooltip" data-id="<?php echo $val['category_id']; ?>" data-bs-original-title="Edit Category"><i class="fa fa-edit"></i></button>
                    </form>
                    
                    <a class="btn tblDelBtn pl-0 pr-0 del_category" type="button" data-bs-toggle="modal" data-id="<?php echo $val['category_id']; ?>" data-bs-original-title="Delete Category" data-bs-target="#exampleModal"><i class="fa fa-trash"></i></a>
...
<!-- Modal for detailed view -->
        ...
        <!--modal for delete confirmation-->
            ...
            <script src="<?php echo base_url();?>assets/owner/js/modules/store.js"></script>