...
<a data-table-id="<?php echo $table['table_id']; ?>" data-order-type="D" data-name="<?php echo $table_name; ?>" class="order-table-list__completed-btn new-order-btn">New Order</a>
                            ...
                            <div class="orders-data__content">
                                ...
                                <div class="orders-data__order-details">
                                    <a data-id="PK" data-bs-toggle="modal" data-name="Completed Pickups"
                                        data-bs-target="#pending_table_orders_popup" class="completed_pickup_orders">
                                        <div
                    ...
                    <div id="tabs5" class="tabs__pane <?php echo !$activeTabSet ? 'active' : ''; ?> ">
                        <?php $activeTabSet = true; ?>
                        <div class="table-status d-block">

                        <button class="all_rooms btn btn-print">All Rooms</button>

                        </div>

                        <div class="restaurant-room-orders order-table-list" id="restaurant-room-orders">
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="emigo-close-btn-kitchen" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="return-order-form">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-print">Return / Replace Order</button>
                </div>
            </form>
        </div>
    </div>
