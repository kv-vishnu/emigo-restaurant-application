 ...
 <?php if($this->session->flashdata('success')){ ?>
                ...
                <div class="">
                                ...
                                <tr>
                                    ...
                                    <td class="pb-0 pt-0 d-flex">
                                        ...
                                        <a class="btn tblDelBtn pl-0 pr-0 del_room" type="button"
                                            ...
                                            data-bs-original-title="Delete Category" data-bs-target="#delete-room"><i
                                                class="fa fa-trash"></i></a>


                                         <?php if($val['store_table_token'] == '0'){ ?>

                         <a target="_blank"  class="btn tblQrcodeBtn btn-btn-secondary pl-0 pr-0 qr-code " type="button" data-bs-toggle="tooltip" data-id="<?php echo $val['table_id']; ?>" data-store-id="<?php echo $val['store_id']; ?>" store-name="<?php echo $store_name; ?>" data-bs-original-title="Download <?php echo $val['table_name']; ?> QR Code"><i class="fa-solid fa-upload"></i></a>
                    ...
                    <?php }
                        ...
                        <a target="_blank" href="<?php echo $val['qr_code']; ?>" class="btn tblEditBtn pl-0 pr-0 download-btn" type="button" data-bs-toggle="tooltip" data-id="<?php echo $val['table_id']; ?>" data-bs-original-title="Download <?php echo $val['table_name']; ?> QR Code"><i class="fa fa-download"></i></a>
                    <?php }
                    ?>
                                    </td>
                                </tr>
