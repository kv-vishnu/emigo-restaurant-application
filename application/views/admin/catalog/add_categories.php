                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-3">
                                                    <input class="form-control" value="<?php echo set_value('code'); ?>"
                                                        type="text" name="code">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="order"
                                                        value="<?php echo set_value('order'); ?>" placeholder="Order">
                                                    <?php if(form_error('order')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('order'); ?></div>
                                                    <?php } ?>
                                                </div>
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-2">
                                                    <input class="form-control"
                                                        value="<?php echo set_value('category_name_ma'); ?>" type="text"
                                                        placeholder="Malayalam" name="category_name_ma">
                                                    <?php if(form_error('category_name_ma')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('category_name_ma'); ?></div>
                                                    <?php } ?>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input class="form-control"
                                                        value="<?php echo set_value('category_name_en'); ?>" type="text"
                                                        placeholder="English" name="category_name_en">
                                                    <?php if(form_error('category_name_en')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('category_name_en'); ?></div>
                                                    <?php } ?>
                                                </div>
                                                <div class="col-sm-3">
                                                    <input class="form-control"
                                                        value="<?php echo set_value('category_name_hi'); ?>" type="text"
                                                        placeholder="Hindi" name="category_name_hi">
                                                    <?php if(form_error('category_name_hi')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('category_name_hi'); ?></div>
                                                    <?php } ?>
                                                </div>
                                                <div class="col-sm-3">
                                                    <input class="form-control"
                                                        value="<?php echo set_value('category_name_ar'); ?>" type="text"
                                                        placeholder="Arabic" name="category_name_ar">
                                                    <?php if(form_error('category_name_ar')){ ?>
                                                    <div class="errormsg mt-2" role="alert">
                                                        <?php echo form_error('category_name_ar'); ?></div>
                                                    <?php } ?>
                                                </div>
                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-2">
                                                    <textarea name="category_desc_ma" class="form-control"
                                                        ...
                                                        rows=""><?php echo set_value('category_desc_ma'); ?></textarea>
