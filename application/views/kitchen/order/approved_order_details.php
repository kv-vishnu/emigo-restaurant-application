    ...
    ?>
        ...
        <div class="accordion-item">
            ...
            <?php
                ...
                if ($order_status == 2)
                {
                    $accept_btn_disabled = 'disabled';
                }
                elseif ($order_status == 1)
                {
                    $ready_btn_disabled  = 'disabled';
                }
                ...
                switch ($order_status) {
                    ...
                    case 1: $btn_text = 'Approved'; $btn_class = 'btn-approve disabled'; break;
            ...
            <div class="action-buttons order-row">
                ...
                <button class="btn btn-print print_table_order" data-order-id="<?= $order['orderno']; ?>">KOT</button>
                <button class="btn btn-delete accept_order" data-order-id="<?= $order['orderno']; ?>" <?= $accept_btn_disabled ?>>COOKING</button>
                <button class="btn btn-pay ready_order" data-order-id="<?= $order['orderno']; ?>" <?= $ready_btn_disabled ?>>READY</button>
            </div>
        </div>
